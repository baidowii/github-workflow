...
--
-- Host: localhost:3306
-- Generation Time: Nov 24, 2021 at 08:52 PM
...
CREATE TABLE `kabupaten` (
  `id_kab` char(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `id_prov` char(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `provinsi` (
  `id_prov` char(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nama_prov` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(20, 'ratnadwikristinasari@gmail.com', 'bXnx6/YKwO5/JyrHH9aMVnIhqxfl1iEQYx04cBh34GI=', 1636547687),
(25, 'ratnadwikristinasari27@gmail.com', 'XvRy+YtiRfJpHyXE5xm7JlJS6LXjSoaEXMr2BY2FhhE=', 1636549936),
(26, 'ratnadwikristinasari27@gmail.com', '4bWcnI1JBntGHogW0dTSRa1MeKqyWqKRqE9Ux7YABxc=', 1636549984),
(27, 'ratnadwikristinasari@gmail.com', 'ZwoH7wpN88kZJ5dDrYY2MyB+NXcu9YrcOjFv+D3CNxE=', 1636550208),
(40, 'hammerpmc021@gmail.com', 'XW3PxxTGCk5etonS0tZfDWiiW1yLU+bxxb8jukBbDfA=', 1637241589),
(43, 'ratnadwikristinasari@gmail.com', 'zSqi2F76W+sNr1aCtDFpWJljF5fheNNitYSJ+QXIxe8=', 1637651479);
...
CREATE TABLE `token_pembayaran` (
  ...
  `notelepon` varchar(14) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `harga` decimal(10,0) NOT NULL,
  `date_created` datetime NOT NULL,
  `kode_event` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `slug_pembayaran` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nama_event` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `status` enum('0','1','2') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '0. Belum Bayar, 1.Proses Pembayaran, 2. Sudah Bayar'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `t_akun` (
  `kode_akun` varchar(12) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `notelepon` varchar(13) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `email` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `jenis_kelamin` enum('1','2') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '1.Laki-laki, 2.Perempuan',
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `foto` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `level` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '0. Super Admin\r\n1. Admin Event',
  `oauth_provider` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `oauth_uid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `kode_otp` int DEFAULT NULL,
  `is_active` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '0=Tidak Aktif, 1= Aktif',
...
('USR000001', 'Admin', 'Jember', '628969355605', 'admin@gmail.com', '1', '202cb962ac59075b964b07152d234b70', 'picture-211118-47b4312f57.jpg', '1', 'common', NULL, NULL, '1', 0),
('USR000002', 'Superadmin', '', '08888888', 'superadmin@gmail.com', '1', 'e10adc3949ba59abbe56e057f20f883e', 'default.jpg', '0', 'common', NULL, NULL, '1', 0),
('USR000003', 'Luqman Hakim', 'Jember', '089693556052', 'luqman.simdig05@gmail.com', '1', '202cb962ac59075b964b07152d234b70', 'default.jpg', '1', 'common', NULL, NULL, '1', 0),
('USR000004', 'Baidowii', 'jember', '08989841713', 'hammerpmc021@gmail.com', '1', '24c2fb77f342e00c2ab0a13cfd49656c', 'default.jpg', '1', 'common', NULL, NULL, '0', 0),
('USR000005', 'Luqman Hakim', 'Jember', '089693556052', 'luqman.simdig05@gmail.com', '1', '202cb962ac59075b964b07152d234b70', 'default.jpg', '1', 'common', NULL, NULL, '1', 0),
('USR000006', 'Luqman Hakim', NULL, NULL, 'e41180965@student.polije.ac.id', NULL, NULL, 'https://lh3.googleusercontent.com/a/AATXAJySVd6pbBzbeNDxvvd2gz1nCinBmMtkpNsWFatQ=s96-c', '1', 'google', '107622107323615121133', NULL, '1', 0),
('USR000007', 'Fus Darjo', 'Sembarang Sidoarjo 21', '081216309410', 'fusdarjo@gmail.com', '1', 'e10adc3949ba59abbe56e057f20f883e', 'default.jpg', '1', 'common', NULL, NULL, '1', 0),
('USR000008', 'Ratna Dwi Kristina Sari', 'Blitar', '081648527650', 'ratnadwikristinasari@gmail.com', '2', '81dc9bdb52d04dc20036dbd8313ed055', 'default.jpg', '1', 'common', NULL, NULL, '0', 0);
...
CREATE TABLE `t_bank` (
  ...
  `no_rek` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `atas_nama_bank` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `kode_akun` varchar(12) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `t_bank` (`kode_bank`, `nama_bank`, `no_rek`, `atas_nama_bank`, `kode_akun`) VALUES
(1, 'BCA', '778898767', 'Baidowiii', 'USR000001');
...
CREATE TABLE `t_detail_event` (
  `kode_det_event` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `kode_event` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `kode_peserta` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `status` enum('1','2') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '1. Belum Bergabung, 2.Sudah Bergabung',
  ...
  `status_pembayaran` enum('0','1','2','3') COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '0 = BelumBayar, 1=Verif, 2= Reject, 3= Sukses',
  `token_pembayaran` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `t_detail_event` (`kode_det_event`, `kode_event`, `kode_peserta`, `status`, `nilai`, `komentar`, `bukti_pembayaran`, `status_pembayaran`, `token_pembayaran`) VALUES
('DETEV000001', 'EV00000003', 'PST000001', '1', NULL, NULL, NULL, NULL, NULL),
('DETEV000002', 'EV00000003', 'PST000002', '1', NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `t_event` (
  `kode_event` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nama_event` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `kode_akun` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `kode_jenis` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `kode_instansi` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `id_prov` char(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `id_kab` char(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `alamat` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `jenis_pelaksanaan` enum('1','2') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '1.Online, 2.Offline',
  `link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` enum('PENDING','CLOSED','FINISH') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `date_created` datetime NOT NULL,
  `lampiran` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'untuk sertifikat',
...
('EV00000003', 'FKMPI Polije Offline', 'USR000001', 'JNS003', 'INS000001', 'poster-211112-bffa7b5f31.jpeg', 'default.jpg', 'default', '35', '3509', 'Jember', '2021-11-23 08:00:00', '2021-11-23 08:00:00', '2021-11-23 10:00:00', '2021-11-13 08:00:00', 'OFFline', 43, 0, '2', 'default', 'PENDING', '2021-11-12 01:00:59', 'default.jpg', 'FKMPI-Polije-Offline0'),
('EV00000004', 'Testimoni Harga', 'USR000001', 'JNS003', 'INS000001', 'poster-211117-3b7ffcd09f.png', 'default.jpg', 'NULL', NULL, NULL, 'default', '2021-11-21 09:22:00', '2021-11-27 09:23:00', '2021-11-22 09:23:00', '2021-11-26 09:23:00', 'Test Harga', 50, 10000, '1', 'https://www.youtube.com/', 'PENDING', '2021-11-17 02:23:27', 'default.jpg', 'Testimoni-Harga0'),
('EV00000005', 'Testimoni Harga Juga', 'USR000001', 'JNS003', 'INS000001', 'poster-211117-5557b0d48a.png', 'default.jpg', 'NULL', NULL, NULL, 'default', '2021-11-22 09:26:00', '2021-11-26 09:26:00', '2021-11-23 09:26:00', '2021-11-25 09:26:00', 'TEst', 50, 10000000, '1', 'https://www.youtube.com/', 'PENDING', '2021-11-17 02:26:28', 'default.jpg', 'Testimoni-Harga-Juga0'),
('EV00000006', 'Expo Amanah Solution', 'USR000001', 'JNS006', 'INS000001', 'poster-211118-2d0f6f7443.png', 'default.jpg', 'NULL', NULL, NULL, 'default', '2021-11-18 08:27:00', '2021-11-20 08:28:00', '2021-11-19 08:28:00', '2021-11-19 08:28:00', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', 100, 10000, '1', 'https://meet.google.com/sun-cvoa-xoq', 'FINISH', '2021-11-18 01:29:01', 'default.jpg', 'Expo-Amanah-Solution0'),
('EV00000007', 'kasih makan ayam', 'USR000001', 'JNS007', 'INS000002', 'poster-211123-5dc8eb5625.jpg', 'default.jpg', 'default', '61', '6107', 'Sembarang Sidoarjo 21', '2021-12-01 02:29:00', '2021-12-01 04:32:00', '2021-11-20 04:29:00', '2021-12-10 03:42:00', 'ayam jago', 109, 100000, '2', 'default', 'PENDING', '2021-11-23 07:31:00', 'default.jpg', 'kasih-makan-ayam0');
...
CREATE TABLE `t_instansi` (
  ...
  `contact` varchar(14) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `slug_instansi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `logo_instansi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('INS000001', 'USR000001', 'Politeknik Negeri Jember', 'Sujono', '576789997985', 'Politeknik-Negeri-Jember', 'instansi-211110-38f065c932.png'),
('INS000002', 'USR000001', 'Amanah Solution', 'Bapak Imam', '123434567', 'Amanah-Solution', 'instansi-211118-5f68c1485a.png');
...
CREATE TABLE `t_konten` (
  ...
  `jenis` enum('1','2') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '1= Slider. 2= FooterPartner'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Eventios Menjadi Solusimu Dari Amanah Solution', 'Eventios merupakan sebuah website yang memudahkan Anda untuk membuat event dan mengikuti event yang Anda minatii. Sukseskan event Anda bersama Eventios.                             ', 'default.jpg', '1'),
...
CREATE TABLE `t_notifikasi` (
  ...
  `kode_event` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `deskripsi_pesan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('PST000001', 'Baidowii', '628989841713', 'hammerpmc021@gmail.com', 'Mojokerto'),
('PST000002', 'Fus Darjo', '6281216309410', 'fusdarjo@gmail.com', 'Sembarang Sidoarjo 21');
...
--
ALTER TABLE `t_bank`
  MODIFY `kode_bank` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
